...
public abstract class Salut implements WifiP2pManager.ConnectionInfoListener {
    ...
    protected SalutServiceData  dataServer;
    ...
    public boolean isInstanceName = false;
    ...
    public Salut(SalutDataReceiver dataReceiver, SalutServiceData salutServiceData, SalutCallback deviceNotSupported) {
        ...
        this.dataServer = salutServiceData;
        ...
        //thisDevice.instanceName = instanceName;
    ...
    public void onConnectionInfoAvailable(final WifiP2pInfo info) {
        ...
        Log.d(TAG,"CHECK IF CONNECTION WORKS");
...
//        BackgroundClientRegistrationJob.onRegistrationFail = onRegistrationFail;
    ...
    public void createGroup( @Nullable final SalutCallback onSuccess, @Nullable final SalutCallback onFailure) {
                    ...
                    public void onGroupInfoAvailable(WifiP2pGroup group) {
                        if (group != null) {
                            if (group.isGroupOwner()) {
                                Salut.this.instanceName = "" + group.getNetworkName() + ":" + group.getPassphrase();
                                Log.d(TAG, "thisDevice instanceName: " + Salut.this.instanceName);
        ...
        //Log.v(TAG, Objects.requireNonNull(dataServer.serviceData.get("NEW_INSTANCE")));


    }
    /*
     my own overriding just to get things right
     */
    ...
    private void createService(final SalutCallback onSuccess, final SalutCallback onFailure) {
        ...
        new Timer().schedule(new TimerTask() {
            ...
            public void run() {
                ...
                //replace the original instanceName with new one
                try {
                    thisDevice.txtRecord.replace("INSTANCE_NAME", instanceName);
                }catch(NoSuchMethodError e){
                    Log.e(TAG,"Wrong method");
                }


                Log.d(TAG, "Starting " + thisDevice.serviceName +" "+ instanceName + " Transport Protocol " + TTP);
                ...
                serviceInfo = WifiP2pDnsSdServiceInfo.newInstance(instanceName, TTP, thisDevice.txtRecord);
...
//
    ...
    public void startNetworkService(@Nullable SalutDeviceCallback onDeviceRegisteredWithHost, @Nullable SalutCallback onSuccess, @Nullable SalutCallback onFailure) {
        ...
        discoverNetworkServices(deviceNotSupported,false);
